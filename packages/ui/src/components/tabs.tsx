...
// NB: classi convertite dal registry shadcn (stile Base UI, data-active/
// data-horizontal boolean) a Radix v1.x, che emette solo data-state="active"
// e data-orientation="horizontal|vertical". Vedi convenzione in repo:
// data-[state=X]: su ogni primitive nuova.
